...
class analisisMamas(models.Model):
	paciente = models.ForeignKey(Paciente, on_delete=models.CASCADE,verbose_name='PACIENTE')
	tegGlandularizq=models.CharField(max_length=3,choices=(('HOMOGENEO', 'Homogéneo'),('HETEROGENEO', 'Heterogéneo')))
	infotegGlandularizq=models.CharField(max_length=100)
	tegGlandularder=models.CharField(max_length=3,choices=(('HOMOGENEO', 'Homogéneo'),('HETEROGENEO', 'Heterogéneo')))
	infotegGlandularder=models.CharField(max_length=100)
	bordesizq=models.CharField(max_length=3,choices=(('REGULAR', 'Regulares'),('IRREGULAR', 'Irregulares')))
	bordesder=models.CharField(max_length=3,choices=(('REGULAR', 'Regulares'),('IRREGULAR', 'Irregulares')))
	ecogenidadizq=models.CharField(max_length=3,choices=(('NORMAL', 'Normal'),('DISMINUIDA', 'Disminuida'),('AUMENTADA', 'Aumentada')))
	ecogenidadder=models.CharField(max_length=3,choices=(('NORMAL', 'Normal'),('DISMINUIDA', 'Disminuida'),('AUMENTADA', 'Aumentada')))
	tejGrasoizq=models.CharField(max_length=3,choices=(('BUENA', 'Buena Cantidad'),('POCA', 'Poca Cantidad')))
	tejGrasoder=models.CharField(max_length=3,choices=(('BUENA', 'Buena Cantidad'),('POCA', 'Poca Cantidad')))
	imgExpansivasizq=models.CharField(max_length=3,choices=(('NO', 'No'),('QUISTICA', 'Quísticas'),('SOLIDA', 'Sólidas')))
	imgExpansivasder=models.CharField(max_length=3,choices=(('NO', 'No'),('QUISTICA', 'Quísticas'),('SOLIDA', 'Sólidas')))
